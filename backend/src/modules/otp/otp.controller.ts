...
export class OtpController {
  ...
  @ApiResponse({ status: 400, description: 'Validation error or rate limit cooldown active' })
  ...
  @ApiResponse({ status: 400, description: 'Invalid, expired, or incorrect OTP code' })
