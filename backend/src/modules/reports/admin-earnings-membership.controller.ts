...
export class AdminEarningsMembershipController {
  ...
  @ApiOperation({
    summary:
      'GET /admin/earnings/membership — List membership earnings ledgers with filters',
    description:
  ...
  @ApiResponse({
    status: 200,
    description: 'Paginated earnings list and summary metrics',
  })
  ...
  @ApiOperation({
    summary:
      'GET /admin/earnings/membership/level-wise — Level-wise earnings aggregation',
    description:
      'Aggregates total earnings, ledger counts, and status breakdowns per level (levels 1..20).',
  })
  @ApiResponse({
    status: 200,
    description: '20-level aggregated earnings table',
  })
  ...
  @ApiOperation({
    summary:
      'GET /admin/earnings/membership/member-wise — Member-wise earnings aggregation',
    description:
      'Aggregates total membership commission earnings grouped by beneficiary member.',
  })
  @ApiResponse({
    status: 200,
    description: 'Member-wise aggregated earnings response',
  })
