...
export class SystemSettingsController {
  ...
  @Get('tds')
  @ApiOperation({ summary: 'Get current system-wide TDS statutory tax deductions setting' })
  ...
  @ApiOperation({ summary: 'Toggle system-wide TDS statutory tax deductions (Admin only)' })
  @ApiResponse({ status: 200, type: TdsStatusResponseDto })
