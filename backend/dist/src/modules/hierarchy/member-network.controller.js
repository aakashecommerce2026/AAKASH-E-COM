...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Level 1 direct referrals list returned successfully' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Matching downline hierarchy nodes array' }),
    (0, swagger_1.ApiResponse)({ status: 401, description: 'Unauthorized' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)('id')),
    __param(1, (0, common_1.Query)()),
    __metadata("design:type", Function),
