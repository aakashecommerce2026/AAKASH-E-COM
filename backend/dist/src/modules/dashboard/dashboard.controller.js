...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Member aggregation statistics returned successfully' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Earnings aggregation statistics returned successfully' }),
    __param(0, (0, common_1.Query)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [query_dashboard_dto_1.QueryDashboardDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Combined business overview statistics returned successfully' }),
    __param(0, (0, common_1.Query)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [query_dashboard_dto_1.QueryDashboardDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Paginated activity feed returned successfully' }),
    __param(0, (0, common_1.Query)()),
    __metadata("design:type", Function),
