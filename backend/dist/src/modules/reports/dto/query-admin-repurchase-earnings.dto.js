...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Filter by general member ID (matches source or beneficiary)' }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Filter by beneficiary member ID (earner)' }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Filter by source member ID (purchaser)' }),
