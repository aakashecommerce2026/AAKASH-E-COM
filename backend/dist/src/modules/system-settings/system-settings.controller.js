...
let SystemSettingsController = class SystemSettingsController {
    ...
    async updateTdsStatus(dto, actorId, actorRole) {
        return this.systemSettingsService.setTdsEnabled(dto.enabled, actorId, actorRole);
    }
};
...
], SystemSettingsController.prototype, "getTdsStatus", null);
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [system_settings_dto_1.UpdateTdsStatusDto, String, String]),
    __metadata("design:returntype", Promise)
], SystemSettingsController.prototype, "updateTdsStatus", null);
