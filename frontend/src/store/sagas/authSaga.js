...
function* loginWorker(action) {
  try {
    ...
    const user = {
      ...
      upiId: backendUser.upiId || backendUser.bankDetails?.upiId || '',
      secondaryUpiId: backendUser.bankDetails?.secondaryUpiId || '',
      upiProvider: backendUser.bankDetails?.upiProvider || 'Google Pay',
      bankDetails: backendUser.bankDetails || null,
